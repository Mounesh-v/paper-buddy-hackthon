...
import { Colors, Spacing, FontSize, BorderRadius, LetterSpacing, Shadows } from '@/constants/colors';
          ...
          <View style={styles.headerActions}>
            ...
            >
              <Ionicons
                ...
                color={Colors.text}
              />
              {dashboardData?.unreadMessages != null && dashboardData.unreadMessages > 0 && (

  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const [academicsData, subjectsData, examsData] = await Promise.all([
        academicsService.getAcademics(childId as string),
        academicsService.getSubjects(childId as string),
        academicsService.getExams(childId as string),
      ]);
      ...
      >
        {academics && (
          <Card style={styles.overviewCard}>
            ...
            {(academics.remark || (academics.remarks && academics.remarks.length > 0)) && (
